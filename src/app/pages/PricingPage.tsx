...
const tiers = [
  {
    ...
    price: '$0',
    period: 'forever',
    description: 'Full-featured vault with generous limits. No credit card required.',
    icon: Globe,
    cta: 'Get started',
    ctaHref: '/get-started',
    ...
    highlight: false,
    features: [
      '10K hosted entries, 1 GB storage',
      '5,000 requests/day',
      'Unlimited API keys',
      ...
      'Multi-device sync',
      'Export & import',
      'Plain markdown files, MIT licensed',
    ],
    note: 'No credit card. No usage surprises.',
  },
  {
    name: 'Pro',
    price: '$9',
    period: '/month',
    description: 'For power users who need more capacity and recall insights.',
    icon: Zap,
    cta: 'Start Pro',
    ctaHref: '/register',
    ...
    features: [
      'Everything in Free',
      '50K hosted entries, 10 GB storage',
      'Unlimited requests',
    ...
    note: 'Soft limit on entries. We never silently delete.',
  },
  {
    name: 'Team',
    price: '$29',
    ...
    features: [
      'Everything in Pro',
      '200K entries per team, 50 GB storage',
      'Shared team vault with privacy controls',
...
const faqs = [
  {
    ...
    a: 'A free account gets you 10K hosted entries, 1 GB storage, and 5,000 requests/day. Or run npx context-vault for a fully local vault with no account at all.',
  },
  {
    q: 'What happens when I hit my entry limit?',
    a: 'You see a dashboard nudge, not a hard block. On Pro, overage is billed at $0.001/entry/month (about $1 for every 1,000 extra entries). We never silently delete entries.',
  },
  {
